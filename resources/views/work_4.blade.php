...
<p style='font-size:11px;line-height:11px;'>1. Виконавець бере на себе зобов&apos;язання виконати вид роботи <strong>&ldquo;Підготовка відповіді щодо технічних показників об’єкту нерухомості для фізичних осіб&rdquo;</strong> за: {{$personal_data}} або за адресою: {{$city}} {{$address}} {{$house_number}} {{$house_building}} {{$apartment}} {{$office}} у <strong>термін визначений замовником</strong>.</p>
...
<p style='font-size:11px;line-height:11px;'><strong>Вид робіт:</strong> <strong>&ldquo;Підготовка відповіді щодо технічних показників об’єкту нерухомості для фізичних осіб&rdquo;.</strong></p>
...
<p style='font-size:6px;font-size:6px; margin: 0;'><span style="font-size:6px;">Ми, що нижче підписались, Замовник&nbsp;</span>{{$personal_data}}<span style="font-size:6px;font-size:6px;">, з однієї сторони та Виконавець з іншої сторони, склали цей Акт в тому, що Виконавцем повністю та в строк повинен виконати вид роботи &ldquo;Підготовка відповіді щодо технічних показників об’єкту нерухомості для фізичних осіб&rdquo;, згідно з договором №&nbsp;</span>{{$code}}<span style="font-size:6px;">&nbsp;від {{$created_at}}&nbsp;</span><span style="font-size:6px;">на суму&nbsp;</span>{{$sum}}<span style="font-size:6px;">&nbsp;грн.</span></p>
<p style='font-size:6px;font-size:6px; margin: 0;'><span style="font-size:6px;font-size:6px;">&nbsp;</span></p>
@php
$f17 = 0.307;
$g17 = 0.065;
