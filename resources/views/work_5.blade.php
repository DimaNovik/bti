...
<body>
    <div>
        ...
        <p class="Standard" style="text-align:justify; line-height:115%;">1. Виконавець бере на себе зобов&apos;язання виконати вид роботи <strong>&ldquo;Підготовка відповіді щодо технічних показників об’єкту нерухомості для юридичних осіб&rdquo;</strong> за адресою: {{$city}} {{$address}} {{$house_number}} {{$house_building}} {{$apartment}} {{$office}} у <strong>термін визначений замовником</strong>.</p>
        ...
        <p class="Standard" style="text-align:justify;"><strong>Вид робіт:</strong> <strong>&ldquo;Підготовка відповіді щодо технічних показників об’єкту нерухомості для юридичних осіб&rdquo;.</strong></p>
        ...
        <p style="text-indent:28.35pt; text-align:justify; font-size:8px;">Ми, що нижче підписались, Замовник {{$personal_data}}, з однієї сторони та Виконавець з іншої сторони, склали цей Акт в тому, що Виконавцем повністю та в строк повинен виконати вид роботи &ldquo;Підготовка відповіді щодо технічних показників об’єкту нерухомості для юридичних осіб&rdquo;, згідно з договором № {{$code}} від {{$created_at}} на суму {{$sum}} грн.</p>
